...
def data_preprocessing(task_1a_dataframe):
	...
	orde = OrdinalEncoder()
	encoded_dataframe['Education'] = orde.fit_transform(encoded_dataframe[['Education']])
	encoded_dataframe = pandas.get_dummies(encoded_dataframe,columns=['City','Gender','EverBenched'])
	##########################################################
...
def identify_features_and_targets(encoded_dataframe):
	...
	x = encoded_dataframe.iloc[:,[0,1,2,3,4,6,7,8,9,10,11]].values
	y = encoded_dataframe.iloc[:,4].values
